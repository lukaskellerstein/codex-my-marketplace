...
description: Create diagrams, charts, graphs, maps, dashboards, infographics, wireframes, and other non-photographic visualizations. Routes work to Mermaid, D3.js, or Draw.io and applies domain-shape search and edge-routing checks for professional output.
---
